...
if (0 < $arResult["SECTIONS_COUNT"] || isset($arParams['UF_NAME']))
{
?>
<?
								...
								<div class="swiper-slide border">
									...
									if (false === $arSection['PICTURE'])
										...
										<a
											...
											title="<? echo $arSection['PICTURE']['TITLE']; ?>"
										>
											<img src="<? echo $arSection['PICTURE']['SRC']; ?>" class="swiper-lazy" />
										</a><?
										if ('Y' != $arParams['HIDE_SECTION_NAME'])
										{
											?>
											<div class="text-left px-25 pt-25 pb-40">
												<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="text-truncate-2 ff-dinpro fw-700 fz-20"><? echo $arSection['NAME']; ?></a>
												<?
												...
												if ($arParams["COUNT_ELEMENTS"] && $arSection['ELEMENT_CNT'] !== null)
												{
													?> <a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="d-inline-block fz-18 fw-700"><? echo $arSection['ELEMENT_CNT']; ?> товаров</a><?
												}
												?>
											</div>
											<?
