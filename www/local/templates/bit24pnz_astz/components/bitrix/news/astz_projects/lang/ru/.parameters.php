...
$MESS["TP_BN_LIST_USE_SHARE"] = "Отображать панель соц. закладок в списке";
...
$MESS["TP_BN_MEDIA_PROPERTY"] = "Свойство для отображения медиа";
$MESS["TP_BN_SLIDER_PROPERTY"] = "Свойство с изображениями для слайдера";
$MESS["TP_BN_THEME_SITE"] = "Брать тему из настроек сайта (для решения bitrix.eshop)";
$MESS["TP_BN_THEME_BLUE"] = "синяя (тема по умолчанию)";
$MESS["TP_BN_THEME_GREEN"] = "зеленая";
...
$MESS["TP_BN_ASPECT_RATIO"] = "Растянуть изображение"
?>