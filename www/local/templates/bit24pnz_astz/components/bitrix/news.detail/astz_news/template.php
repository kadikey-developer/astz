...
<div class="container">
	<?if($arParams["DISPLAY_DATE"]!="N" && $arResult["DISPLAY_ACTIVE_FROM"]):?>
		<div class="news-detail-date py-20">Дата публикации: <?echo $arResult["DISPLAY_ACTIVE_FROM"]?></div>
	<?endif?>
	<div class="mb-3" id="<?echo $this->GetEditAreaId($arResult['ID'])?>">
		...
		<div class="news-detail-body">
			...
			<?if($arParams["DISPLAY_NAME"]!="N" && $arResult["NAME"]):?>
				<h3 class="ff-dinpro"><?=$arResult["NAME"]?></h3>
			<?endif;?>

			<div class="text-grey fz-lg-18 fz-xl-20 px-xl-40">
